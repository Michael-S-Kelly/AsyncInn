...
namespace AsyncInn.Controllers
{
    public class HotelRoomController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("HotelID,RoomID")] HotelRoom hotelRoom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HotelID,RoomID")] HotelRoom hotelRoom)
        {
